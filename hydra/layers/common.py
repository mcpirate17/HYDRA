...
class SwiGLUMLP(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # Use PyTorch implementation for gradient compatibility
        # Triton kernel available via fused_swiglu() for inference
...
class RotaryEmbedding(nn.Module):
    ...
    def forward(self, x: torch.Tensor, seq_len: int = None) -> torch.Tensor:
        ...
        # Use PyTorch implementation (more robust)
        # Triton RoPE kernel can be enabled manually for benchmarking
