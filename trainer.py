...
def run_cli() -> None:
    ...
    parser.add_argument("--mor_enable_pct", type=float, default=0.30, help="MoR curriculum: enable adaptive routing after this %% of training (0.0-1.0, default 0.30). Separate from LR warmup.")
    ...
    parser.add_argument("--mod_enable_pct", type=float, default=0.10, help="MoD curriculum: enable token dropping after this %% of training (0.0-1.0, default 0.10). Before this point, MoD is disabled (dense MLP).")
    ...
    parser.add_argument("--model_size", type=str, default="100M", choices=["DIAG", "100M", "debug_tall_skinny", "250M", "300M", "500M", "750M", "1B", "1.5B"], help="Model size preset")
    ...
    config = TrainingConfig(
        ...
        compile_mode="max-autotune",  # Changed from max-autotune-no-cudagraphs
        dtype="bfloat16",
