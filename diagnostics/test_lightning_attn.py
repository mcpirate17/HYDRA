...
def test_integration_with_hydra():
    ...
    try:
        ...
        # Create a small model with lla2x3+ccqa pattern
        os.environ["HYDRA_MOR_ATTENTION_PATTERN_NAME"] = "lla2x3+ccqa"

        print("Creating HYDRA model with lla2x3+ccqa attention...")
